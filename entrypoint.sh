...
# ----------------------------------------------------
# 1. УСТАНОВКА ПРАВ ДОСТУПА К СКРИПТУ ENTRYPOINT (Критично)
# ----------------------------------------------------
# На случай, если флаг +x был потерян при копировании или Git.
# Эта команда всегда должна стоять первой для самозащиты.
chmod +x /app/entrypoint.sh

# ----------------------------------------------------
# 2. ОЖИДАНИЕ БАЗЫ ДАННЫХ (имя сервиса 'db' и порт 5432)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 3. УСТАНОВКА ПРАВ ДОСТУПА К ТОМАМ (Решает Проблему 1)
# ----------------------------------------------------
