# Generated by Django 5.2.4 on 2025-11-04 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.direction', verbose_name='Направление')),
            ],
            options={
                'verbose_name': 'Проект',
